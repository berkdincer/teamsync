  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-accent-600 via-accent-500 to-primary-500"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <div className="mb-8">
            ...
            <p className="text-xl text-white/80 mt-4 max-w-md">
              ...
              Join via link, add task, click done.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Create a project and invite your team in seconds</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-white font-semibold">Clear Responsibilities</h3>
                <p className="text-white/70 text-sm">Assign roles like &quot;AI Developer&quot; or &quot;Frontend Lead&quot;</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-white font-semibold">Celebrate Wins</h3>
                <p className="text-white/70 text-sm">Confetti animations when tasks are completed</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-accent-400 to-accent-600 flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl font-bold text-white">T</span>
            </div>
            <h1 className="text-2xl font-display font-bold text-white">TeamSync</h1>
          </div>
          ...
          <div className="glass rounded-2xl p-8">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-dark-900 text-white/40">or continue with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-accent-500/50"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-gradient-to-r from-accent-500 to-accent-600 text-white font-medium hover:from-accent-600 hover:to-accent-700 transition-all disabled:opacity-50 btn-glow"
              >
                {loading ? (
